...
export const healthyPeriodontalProfile: PeriodontalReading[] = [
  ...
  {
    toothNumber: 1,
    pocketDepths: [2, 2, 2, 2, 2, 2],
    gingivalIndex: [0, 0, 0, 0],
    bleedingPoints: [false, false, false, false, false, false],
  },
  {
    toothNumber: 2,
    pocketDepths: [2, 2, 2, 2, 2, 2],
...
export const mildGingivitisProfile: PeriodontalReading[] = [
  // Upper Right Quadrant (1-8)
  {
    ...
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [false, true, false, false, true, false],
  },
  {
    toothNumber: 2,
    pocketDepths: [3, 4, 3, 3, 4, 3],
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [true, true, false, true, true, false],
  },
  {
    toothNumber: 3,
    pocketDepths: [3, 3, 4, 3, 3, 3],
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [false, false, true, false, false, true],
  },
  {
    toothNumber: 4,
    pocketDepths: [3, 3, 3, 3, 3, 3],
  ...
  },
  {
    ...
    pocketDepths: [3, 3, 3, 3, 3, 3],
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [true, false, false, true, false, false],
  },
  {
    toothNumber: 6,
    pocketDepths: [4, 4, 3, 4, 4, 3],
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [true, true, false, true, true, false],
  },
  {
  ...
  },
  {
    ...
    pocketDepths: [3, 4, 3, 3, 4, 3],
    gingivalIndex: [1, 1, 1, 1],
    bleedingPoints: [false, true, true, false, true, true],
  },
...
export const moderatePeriodonitisProfile: PeriodontalReading[] = [
  ...
  {
    toothNumber: 1,
    pocketDepths: [4, 5, 4, 4, 5, 4],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, true, true, true, true, false],
    notes: 'Moderate inflammation',
  },
  {
    toothNumber: 2,
    pocketDepths: [5, 6, 5, 5, 6, 5],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, true, true, true, true, true],
    notes: 'Bone loss evident',
  },
  {
    toothNumber: 3,
    pocketDepths: [4, 4, 5, 4, 4, 5],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, false, true, true, false, true],
  },
  {
    toothNumber: 4,
    pocketDepths: [4, 5, 4, 4, 5, 4],
  ...
  {
    toothNumber: 5,
    pocketDepths: [5, 5, 4, 5, 5, 4],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, true, true, true, true, false],
  },
  {
    toothNumber: 6,
    pocketDepths: [6, 6, 5, 6, 6, 5],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, true, true, true, true, true],
    mobility: 1,
    furcation: 1,
    notes: 'Class I furcation involvement',
  },
  {
    toothNumber: 7,
    pocketDepths: [4, 5, 4, 4, 5, 4],
...
export const severePeriodonitisProfile: PeriodontalReading[] = [
  ...
  {
    toothNumber: 2,
    pocketDepths: [7, 8, 7, 7, 8, 7],
    gingivalIndex: [3, 3, 3, 3],
    bleedingPoints: [true, true, true, true, true, true],
    mobility: 2,
    notes: 'Severe bone loss, consider extraction',
  },
  {
    toothNumber: 3,
    pocketDepths: [6, 7, 6, 6, 7, 6],
    gingivalIndex: [3, 3, 3, 3],
    bleedingPoints: [true, true, true, true, true, true],
    mobility: 1,
  },
  ...
  {
    toothNumber: 5,
    pocketDepths: [6, 6, 6, 6, 6, 6],
    gingivalIndex: [2, 2, 2, 2],
    bleedingPoints: [true, true, true, true, true, true],
  },
  {
    toothNumber: 6,
    pocketDepths: [8, 8, 7, 8, 8, 7],
    gingivalIndex: [3, 3, 3, 3],
    bleedingPoints: [true, true, true, true, true, true],
    mobility: 2,
    furcation: 2,
    notes: 'Class II furcation, severe mobility',
  },
  {
    toothNumber: 7,
    pocketDepths: [6, 7, 6, 6, 7, 6],
  ...
  },
  {
    ...
    bleedingPoints: [true, true, true, true, true, true],
    mobility: 2,
    notes: 'Severe bone loss',
  },
];

// Export a function to get periodontal data by patient age/risk profile
export const getPeriodontalDataForPatient = (
  age: number,
  hasPeriodontalDisease: boolean = false,
): PeriodontalReading[] => {
