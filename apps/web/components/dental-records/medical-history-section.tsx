  ...
  const saveEditor = () => {
    ...
    if (editorType === 'allergy') {
      ...
      const nextItem = {
        ...
        severity: (form.severity || 'moderate') as
          | 'mild'
          | 'moderate'
          | 'severe'
          | 'life_threatening',
      ...
      commitMedicalHistory({
        ...
        past_surgeries:
          editorMode === 'add'
            ...
            : medicalHistory.past_surgeries.map((item) =>
                item.id === editingId ? nextItem : item,
              ),
      });
      closeEditor();
      ...
      {(medicalHistory.allergies.some((a) => a.severity === 'life_threatening') ||
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-red-900 mb-2">⚠️ Medical Alert</h3>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{medicalHistory.allergies.length} documented</p>
            </div>
          </div>
          <button
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    <button
                      onClick={() =>
                        openEditor('allergy', 'edit', allergy as unknown as Record<string, unknown>)
                      }
            ...
            {medicalHistory.systemic_conditions.map((condition) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <h4 className="font-bold text-gray-900 capitalize">{condition.condition}</h4>
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${statusColors[condition.status]}`}
                      >
                        {condition.status}
                      </span>
                      <span
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm text-gray-700 mb-2">
                      ...
                      {surgery.dental_implants && (
                        <p className="text-blue-700 font-medium">✓ Dental implants involved</p>
                      )}
                    </div>
                    ...
                    {surgery.notes && <p className="text-sm text-gray-600 mt-2">{surgery.notes}</p>}
                  </div>
                  <div className="flex items-center space-x-1">
                    <button
                      onClick={() =>
                        openEditor('surgery', 'edit', surgery as unknown as Record<string, unknown>)
                      }
                      className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <p className="text-sm text-gray-700 capitalize mb-2">
              ...
              <span
                className={`px-2 py-0.5 rounded ${
                  medicalHistory.lifestyle_factors.smoking.status === 'current'
                    ? 'bg-red-100 text-red-800'
                    : medicalHistory.lifestyle_factors.smoking.status === 'former'
                      ? 'bg-yellow-100 text-yellow-800'
          ...
          <div className="p-4 rounded-lg bg-gradient-to-br from-gray-50 to-white border border-gray-200">
            ...
            <p className="text-sm text-gray-700 capitalize mb-2">
              ...
              <span
                className={`px-2 py-0.5 rounded ${
                  medicalHistory.lifestyle_factors.alcohol.frequency === 'heavy'
                    ? 'bg-red-100 text-red-800'
                    : medicalHistory.lifestyle_factors.alcohol.frequency === 'moderate'
                      ? 'bg-yellow-100 text-yellow-800'
                      : medicalHistory.lifestyle_factors.alcohol.frequency === 'occasional'
          ...
          {medicalHistory.lifestyle_factors.diet_notes && (
            <div className="p-4 rounded-lg bg-gradient-to-br from-gray-50 to-white border border-gray-200">
              ...
              <p className="text-sm text-gray-700">{medicalHistory.lifestyle_factors.diet_notes}</p>
            </div>
          )}
            ...
            {medicalHistory.family_health_history.map((family) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <h4 className="font-semibold text-gray-900 capitalize">{family.relation}</h4>
                  <div className="flex items-center space-x-1">
                    <button
                      onClick={() =>
                        openEditor('family', 'edit', family as unknown as Record<string, unknown>)
                      }
          ...
          <div className="p-4 rounded-lg bg-sky-50 border border-sky-200">
            ...
            <p
              className={`text-lg font-bold ${
                medicalHistory.dental_history.dental_anxiety_level === 'severe'
                  ? 'text-red-600'
                  : medicalHistory.dental_history.dental_anxiety_level === 'moderate'
                    ? 'text-orange-600'
                    : medicalHistory.dental_history.dental_anxiety_level === 'mild'
                      ? 'text-yellow-600'
                      : 'text-green-600'
              }`}
            >
                ...
                .map((treatment) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600 mb-1">Dr. {treatment.dentist_name}</p>
          ...
          <div className="w-full max-w-2xl bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden">
            ...
            <div className="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
              {(editorType === 'allergy' ||
                ...
                editorType === 'family') && (
                <p className="text-sm text-gray-500">
                  Use this editor to update details without leaving the patient chart.
                </p>
              )}
              ...
              {editorType === 'allergy' && (
                <>
                  ...
                  <input
                    ...
                    onChange={(e) => updateField('date_identified', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <textarea
                    value={form.notes || ''}
              ...
              {editorType === 'medication' && (
                <>
                  ...
                  <input
                    ...
                    onChange={(e) => updateField('prescribing_doctor', e.target.value)}
              ...
              {editorType === 'condition' && (
                <>
                  ...
                  <input
                    ...
                    onChange={(e) => updateField('diagnosed_date', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <select
              ...
              {editorType === 'lifestyle' && (
                <>
                  <select
                    value={form.smoking_status || 'never'}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <input
                      value={form.packs_per_day || ''}
                      onChange={(e) => updateField('packs_per_day', e.target.value)}
                  ...
                  <input
                    ...
                    onChange={(e) => updateField('quit_date', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <select
                    value={form.alcohol_frequency || 'none'}
                    onChange={(e) => updateField('alcohol_frequency', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  >
                  ...
                  <input
                    value={form.drinks_per_week || ''}
                    onChange={(e) => updateField('drinks_per_week', e.target.value)}
              ...
              {editorType === 'dental' && (
                <>
                  <input
                    type="date"
                    value={form.last_cleaning_date || ''}
                    onChange={(e) => updateField('last_cleaning_date', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <input
                    type="date"
                    value={form.last_exam_date || ''}
                    onChange={(e) => updateField('last_exam_date', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <select
                    value={form.dental_anxiety_level || 'none'}
                    onChange={(e) => updateField('dental_anxiety_level', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  >
                  ...
                  <select
                    value={form.previous_orthodontics || 'no'}
                    onChange={(e) => updateField('previous_orthodontics', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  >
                  ...
                  <input
                    value={form.orthodontics_details || ''}
                    onChange={(e) => updateField('orthodontics_details', e.target.value)}
                    placeholder="Orthodontics details"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  />
                  <select
                    value={form.previous_implants || 'no'}
                    onChange={(e) => updateField('previous_implants', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                  >
