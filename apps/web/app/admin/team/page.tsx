      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Invite colleagues to your practice and manage pending invites.
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 bg-white pl-10 pr-3 text-slate-900 outline-none focus:border-[#3e8ba8] focus:ring-2 focus:ring-[#99d6e4]"
              />
            </div>
          </div>
          <div>
            ...
            <select
              ...
              className="h-11 rounded-xl border border-slate-200 bg-white px-3 text-slate-900 outline-none focus:border-[#3e8ba8] focus:ring-2 focus:ring-[#99d6e4]"
            >
              {ROLES.map((r) => (
          ...
          <button
            disabled={submitting}
            type="submit"
            className="h-11 rounded-xl bg-slate-900 px-5 text-sm font-medium text-white transition hover:bg-slate-800 disabled:opacity-60"
          >
        ...
        {lastLink && (
          <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 p-3">
            ...
            <div className="mt-2 flex items-center gap-2">
              <code className="flex-1 truncate rounded-lg bg-white px-3 py-2 text-xs text-slate-700">
                {lastLink}
              </code>
              <button
                type="button"
            ...
            {invites.map((inv) => (
              <li key={inv.id} className="flex items-center justify-between px-5 py-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200"
                >
