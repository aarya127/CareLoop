                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-2">
                      {patient.has_allergies && (
                        <div className="p-1.5 bg-yellow-100 rounded-lg" title="Has Allergies">
                      ...
                      {patient.has_outstanding_balance && (
                        <div className="p-1.5 bg-red-100 rounded-lg" title="Outstanding Balance">
            ...
            <div className="grid grid-cols-1 gap-4 px-6 py-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewPatientForm((prev) => ({ ...prev, phone: e.target.value }))
                  }
                  className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
