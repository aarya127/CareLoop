# 🦷 CareLoop - AI Dental Practice Management# 🦷 CareLoop - AI-Powered Dental Practice Management# CareLoop - AI Dental Practice Management



> AI-powered demo built with Next.js 15, React 18, and TypeScript.
...
```bash![CareLoop Demo](https://img.shields.io/badge/Status-Demo%20Ready-brightgreen?style=for-the-badge)## 🚀 Features

# 1) Install dependencies

npm install![Next.js](https://img.shields.io/badge/Next.js-15-black?style=for-the-badge&logo=next.js)



# 2) Start the dev server (http://localhost:3000)![TypeScript](https://img.shields.io/badge/TypeScript-5-blue?style=for-the-badge&logo=typescript)- **AI Receptionist**: Handles inbound/outbound calls 24/7
...
Login at http://localhost:3000/login using any demo account:- **Patient Profiles**: Rich demographics, clinical records, insurance, and billing

- Email: admin@careloop.demo (or doctor@ / hygienist@ / receptionist@)

- Password: demo123## 🚀 Quick Start- **Real-time Updates**: Live call status and appointment notifications



After login you’ll be redirected to http://localhost:3000/admin- **Premium UI**: Apple.com-level design with tactile micro-interactions
...
## 📍 Admin Pages# Install dependencies

- Dashboard: `app/admin/page.tsx`

- Patients: `app/admin/patients/page.tsx`npm install## 🛠️ Tech Stack

- Calendar: `app/admin/calendar/page.tsx`

- AI Assistant: `app/admin/ai-assistant/page.tsx`

- Messaging: `app/admin/messaging/page.tsx`

- Analytics: `app/admin/analytics/page.tsx`# Run development server### Frontend

- Settings: `app/admin/settings/page.tsx`

- Admin Layout (sidebar/nav): `components/admin/admin-layout.tsx`npm run dev- **Next.js 14+** with App Router
...
## ✅ What Was Fixed# Open http://localhost:3000- **TypeScript** for type safety

- Fixed login redirect loop by generating a valid mock JWT (header.payload.signature) and decoding it properly.

- Removed the login loading screen to avoid timing conflicts.```- **Tailwind CSS** for styling

- Ensured AdminLayout waits for auth to finish before redirecting.

- **shadcn/ui** for component primitives

If you still bounce back to /login:

1) Clear browser storage for this site (localStorage)**🎭 Demo Login:** Choose any role on the landing page  - **Framer Motion** for animations

2) Stop server and clear cache:

- Password for all accounts: `demo123`- **FullCalendar** for scheduling

```bash

rm -rf .next- **TanStack Query** for data fetching
...
➡️ `COMPLETE_DOCUMENTATION.md`

- Vercel Analytics for telemetry

This includes features, architecture, RBAC, pages, troubleshooting, and development notes.
